...
\defineTitle{20}{Endliche Modelle/Gödels Sätze}{5. Juli 2017}
...
(durch Normalisierung möglich)\bigskip
...
in der Regel an, dass $c^\Inter=c$ ist.
...
\theobox{Satz: Jedes formale System, in dem eine gewisse Menge elementarer Arithmetik

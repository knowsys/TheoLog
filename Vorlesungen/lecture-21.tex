...
\defineTitle{21}{Endliche Modelle und Datenbanken}{2. Juli 2018}
...
\[
   Q_2[x_2] = \exists x_1,z_\text{Linie}.(\text{verbindung}(x_1,x_1,z_\text{Linie})\wedge Q_1[x_1])
\]\pause
...
% \}
% \end{align*}
% folgen genau die Antworten $\text{Erreichbar}(\Scodelit{\texttt{helmholtzstr}})$, $\text{Erreichbar}(\Scodelit{\texttt{räcknitzhöhe}})$ und $\text{Erreichbar}(\Scodelit{\texttt{zellescher\_weg}})$.
% }
% 
% \end{frame}
% 

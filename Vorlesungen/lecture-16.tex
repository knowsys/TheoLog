...
\defineTitle{16}{Logisches Schließen (2)}{18. Juni 2026}
...
\begin{itemize}
\item Logisches Schließenn ist unentscheidbar: kein Verfahren kann die Frage nach Allgemeingültigkeit sicher beantworten
...
\anybox{strongyellow}{
\emph{Rückblick:} Resolution in Aussagenlogik (siehe 4. Vorlesung)%
\begin{itemize}

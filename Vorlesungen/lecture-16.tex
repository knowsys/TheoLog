...
\defineTitle{16}{Logisches Schließen (2)}{16. Juni 2017}
...
\item Das Verfahren ist \redalert{vollständig} (es kann jede Tautologie auch irgenwie ableiten) -- ein Durchbruch, Gödels Vollständigkeitssatz
\end{itemize}
...
Benennen wir $x$ dagegen in $y$ um, dann entsteht $\forall x.\exists y.\textsf{hatVater}(y,y)$ ("`Jemand ist sein eigener Vater"').
}

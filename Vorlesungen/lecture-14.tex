...
\defineTitle{14}{Modelltheorie und logisches Schließen}{4. Juni 2018}
...
\visible<6->{\node[above right=-1pt of {f4}, outer sep=0pt] {\footnotesize$F_4$: widersprüchlich, widerlegbar};}
...
\theobox{Satz (Deduktionstheorem): Für jede Formelmenge $\mathcal{F}$ und Formeln $G$ und $H$ gilt\\
$\mathcal{F}\models G\to H$ genau dann wenn $\mathcal{F}\cup\{G\}\models H$.}\bigskip

\theobox{Korollar: $F\wedge G\models H$ genau dann wenn $F\models G\to H$.}\bigskip

...
\defineTitle{14}{Modelltheorie ud logisches Schließen}{31. Mai 2017}
...
Wir betrachten die einige "`representative"' Modelle von $F_1$, eine Formalisierung
...
Manchmal wird auch $\not\approx$ als Prädikat eingeführt. Wir können das 
aber auch leicht definieren:
...
Es stellt sich heraus, dass man ganz allgemein jede Verwendung von $\approx$ einsparen
kann:
...
\forall x_1,\ldots,x_n,y. & \big(p(x_1,\ldots, x_{i-1},x_i,x_{i+1},\ldots,x_n)\wedge{}\\
&\eqpred(x_i,y) )\to p(x_1,\ldots, x_{i-1},y,x_{i+1},\ldots,x_n)\big) & \text{Kongruenz}
\end{align*}
...
und weiteren Prädikatensymbolen aus der endlichen Menge $\Slang{R}$.\bigskip

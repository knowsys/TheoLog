...
\begin{itemize}
\item schriftliche Prüfung (90min) am Ende des Sommersemesters
...
\item Wer im Sommer eine 2. Wiederholungsprüfung antritt und nicht besteht, beendet sein Studium vor dem Übertritt. Der zweite Fehlversuch kann nicht gelöscht werden.
...
%
\item Christopher Moore, Stephan Mertens: \emph{The Nature of Computation.} Oxford University Press\\
...
{\footnotesize\textcolor{devilscss}{Graphic Novel, inspiriert von Russells Leben und der Geschichte der \ghost{Logik}}}
%
...
% \item \redalert{Inferenz:} Spezifikation der korrekten logischen Schlussfolgerungen (Welche neuen Formeln kann man aus den bekannten ableiten?)
...
\redalert{Logik}, logisches Modellieren und logisches Schlussfolgern haben in der Informatik viele direkte und indirekte Anwendungen.
\bigskip

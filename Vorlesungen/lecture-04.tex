...
\defineTitle{4}{Das Halteproblem, Reduktionen und der Satz von Rice}{19. April 2017}
...
\narrowcentering{$\overline{\Slang{P}}_{\textsf{Halt}} = \{\textsf{enc}(\Smach{M})\Sterm{\#}\Sterm{\#}\textsf{enc}(w)\mid \text{$\Smach{M}$ hält bei nicht Eingabe $w$}\}$}\\[1ex]
%
...
\item Ein Problem von Emil Post \ldots
\item \ldots und eines zu kontextfreien Sprachen
\end{itemize}
}

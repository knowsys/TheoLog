...
ist. Bei Anwendung des Distributivgesetzes erhalten wir die folgende KNF:
\begin{align*}
...
\begin{itemize}
\item Eine Klausel $L_1\vee\ldots\vee L_n$ wird dargestellt als Menge $\{L_1,\ldots,L_n\}$
...
Ein einzelner Resolutionsschritt funktioniert wie folgt:

...
% \path[->,line width=0.5mm](C) edge[] node[above,align=left] {$\blank\mapsto\Sterm{x},R$} (D);
...
% \path[->,line width=0.5mm](E) edge[] node[above,align=left] {$\Sterm{x}\mapsto\Sterm{x},R$} (F);
% \path[->,line width=0.5mm](A) edge[] node[left] {$\blank\mapsto\blank,R$} (F);
% 

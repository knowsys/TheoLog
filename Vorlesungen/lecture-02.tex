...
\defineTitle{2}{Logische Schlussfolgerungen und Äquivalenzen}{16. April 2026}
...
Aufgabe: 
\begin{itemize}
\item Fülle jedes Feld mit einer Ziffer von $1$ bis $9$, sodass
...
\begin{enumerate}
\item \alert{Vokabular festlegen:} Welche Atome sollen verwendet werden, um eine Instanz der Frage und ihrer Lösung darzustellen?
...
\medskip
\begin{itemize}
\item Schritt 1 kann zu hunderten oder tausenden Atomen führen (die ja jeweils nur ein \ghost{Bit)}\\ $\leadsto$ keine Angst vor großen Vokabularen
...
wenn sie genau dieselben Modelle haben, d.h. wenn\\[1ex]
...
In der rekursiven Definition von $\models$ erfüllt daher die Teilformel $G$ genau dieselben Bedingungen wie $G'$, sodass sich auch für $F$ und $F'$ derselbe Wert ergibt.\qed
\bigskip
...
Mit dem Deduktionstheorem und dem Bezug von Formelmengen und Konjunktionen erhält man ein weiteres interessantes
Ergebnis:\medskip
...
\begin{frame}\frametitle{Der SMT-Solver Z3}

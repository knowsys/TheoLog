...
\defineTitle{7}{Beziehungen zwischen Komplexitätsklassen / Effizient lösbare Probleme}{7. Mai 2026}
...
(ohne Beweis; folgt aus dem sogenannten \alert{Time (bzw. Space) Hierarchy Theorem})
...
Aus der 4. Vorlesung kennen wir bereits ein typisches \Scomplclass{P}-Problem.\bigskip
...
\item Eine Formel ist \alert{erfüllbar}, wenn sie für eine Wertzuweisung auf wahr abgebildet \ghost{wird}
\item Eine Menge von Formeln ist erfüllbar, wenn es eine Wertzuweisung gibt, die alle
...
\emph{Gegeben:} Eine Menge von Hornklauseln\\
...
Wenn wir eine robuste Klasse wollen, die Linearzeit-Algorithmen enthält, dann enthält sie auch beliebige polynomielle Algorithmen.\bigskip

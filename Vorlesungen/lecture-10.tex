...
\defineTitle{10}{NP-Vollständigkeit, Teil 2}{21. Mai 2026}
...
\begin{frame}
  ...
  \pause\emph{Gesuchte Zahl: } Wir bestimmen die gesuchte Zahl $z$ wie folgt:\\
  \[
...
\emph{Frage:} Gibt es eine Teilmenge $T\subseteq G$, sodass
\begin{itemize}
...
\examplebox{\emph{Beispiel:} DNS-Rechner lösen Optimierungsaufgaben, aber müssen alle (exponentiell viele) möglichen Lösungen als DNS-Sequenz kodieren.}
...
\begin{frame}\frametitle{\Scomplclass{P} vs. \Scomplclass{NP}}
  ...
  \item 1.000.000 USD Preisgeld für die Lösung\\("`Millennium-Problem"')
  \end{itemize}
...
\begin{itemize}
\item Die meisten Expert:innen glauben das nicht

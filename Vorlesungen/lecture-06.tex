...
\defineTitle{6}{Unentscheidbare Probleme formaler Sprachen}{29. April 2021}
...
\theobox{\emph{Satz (aus Formale Systeme):} Das \alert{Schnittproblem regulärer Grammatiken} ist entscheidbar.\\
...
\theobox{\emph{Satz (aus Formale Systeme):} Das \alert{Schnittproblem kontextfreier Grammatiken} ist unentscheidbar.\\
...
\theobox{\emph{Satz (Formale Systeme):}
\begin{itemize}
...
%% Anmerkung: 65537=2^{2^4}+1 kann wie jede Primzahl dieser Form ("Fermatische Primzahl) konstruiert werden;

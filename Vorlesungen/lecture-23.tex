...
\defineTitle{23}{Gödels~1.~Unvollständigkeitssatz}{16. Juli 2026}
...
Was Gödel 1931 zeigte, war grob gesagt folgendes:\medskip
...
{\tiny(dies ist möglich, da die Menge aller Wörter abzählbar ist, siehe Formale Systeme im WiSe; natürlich gibt es viele mögliche Zuordnungen).
...
\item $(x+1)^2+(y+1)^2=(z+1)^2$ (unendlich viele Lösungen; vgl. Pythagoreische Tripel)

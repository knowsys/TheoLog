...
\defineTitle{23}{Gödels~1.~Unvollständigkeitssatz}{9. Juli 2018}
...
\examplebox{Beispiel: Die Prädikatenlogik liefert formale Systeme:
\begin{itemize}
...
\item $x^4+y^4=z^4$ (genau zwei Lösungen: $x=y=z=0$ und $x=y=z=1$; Fermatsche Vermutung)
\end{itemize}
}
